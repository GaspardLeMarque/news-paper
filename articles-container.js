const articles = [
	{id: 1, title: 'India withdraws Most Favoured Nation status to Pak', 
	...
	{id: 2, title: 'UK PM Theresa May loses vote on her Brexit strategy', 
	...
	{id: 3, title: 'Facebook and US government negotiating multi-billion-dollar fine',
...
//const { id1, id2, id3 } = articles; //create IDs with destructuring assignment
//let clone = Object.assign(IDcontainer, articles); //create container of IDs